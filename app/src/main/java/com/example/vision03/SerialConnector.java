...
import com.example.vision03.MainActivity.SerialListener;
...
//                mListener.onReceive(Constants.MSG_SERIAL_ERROR, 0, 0, "Failed in sending command. : IO Exception \n", null);
                Log.d("sendCommand", "Failed in sending command. : IO Exception");
            }
        }
    }
                ...
                if (mPort != null) {
                    ...
                    try {
                        ...
                        if (numBytesRead > 0) {
                            ...
                            Message msg = mHandler.obtainMessage(Constants.MSG_READ_DATA_COUNT, numBytesRead, 0, new String(buffer));
